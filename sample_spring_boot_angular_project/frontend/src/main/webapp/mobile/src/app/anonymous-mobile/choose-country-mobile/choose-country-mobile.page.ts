...
import { ChooseCountryStep, Country } from '../../../../../web/src/app/anonymous/choose-country/choose-country.model';
import { ChooseCountryService } from '../../../../../web/src/app/anonymous/choose-country/choose-country.service';
import { CallbackHandlerService } from '../../../../../web/src/app/utils/callback-handler.service';
import { MessagesService } from '../../../../../web/src/app/utils/messages.service';
...
import { ValidationService } from '../../../../../web/src/app/utils/validation.service';
...
@Component({
  selector: 'zum-choose-country-mobile',
  templateUrl: './choose-country-mobile.page.html',
  styleUrls: ['./choose-country-mobile.page.scss'],
})
export class ChooseCountryMobilePage implements OnInit {
  ...
  public checkSupportedCountry(): void {
    ...
    if (this.validationService.isStringNotEmpty(this.chosenCountry) === false) {
      this.messagesService.show('choose_your_country.message.empty_country');
      return;
    }
  ...
  public autocompleteBlurHandler() {
    ...
    } else if (this.chosenCountry.length > 0) {
      this.countryInputCtrl.setValue(label);
  ...
  public subscribe() {
    ...
    if (this.validationService.isSomeStringEmpty(email, firstName, lastName) === true) {
      this.messagesService.show('common.all_fields_are_mandatory');
      return;
    }

    if (this.validationService.isEmailValid(email) === false) {
      this.messagesService.show('common.email_is_invalid');
      return;
    }
